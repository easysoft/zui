...
+function($, window, document, Math)
{
    ...
    ChosenIcons.DEFAULTS = 
    {
        ...
        otherIcons: ['desktop', 'laptop', 'tablet', 'mobile-phone', 'building', 'firefox', 'ie', 'opera', 'qq', 'lemon', 'sign-blank', 'circle', 'circle-blank', 'terminal', 'html5', 'android', 'apple', 'windows', 'weibo', 'renren', 'bug', 'moon', 'sun']
    };
    ...
    ChosenIcons.prototype.init = function()
    {
        ...
        $this.chosen({placeholder_text:' ', disable_search: true, width: '100%', inherit_select_classes: true});
