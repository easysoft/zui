...
<Example>
  <div class="flex gap-6 -mb-6">
    <div>
      <div class="-w-20 -h-8 flex justify-center items-center -border" style="background-color: inherit;"></div>
    ...
    <div>
      <div class="-w-20 -h-8 flex justify-center items-center -border" style="background-color: transparent;"></div>
      <div class="text-center">透明</div>
    </div>
    <div>
      <div class="-w-28 -h-8 flex justify-center items-center -border" style="background-color: #fff;"></div>
