...
| --- | --- | --- |
| [`preact`](https://preactjs.com/) | [MIT](https://github.com/preactjs/preact/blob/main/LICENSE) | 轻量的 React 替代框架，作为部分界面组件的基础框架，包括 `@preact/signals` |
| [`tailwindcss`](https://tailwindcss.com/) | [MIT](https://github.com/tailwindlabs/tailwindcss/blob/master/LICENSE) | 用于提供 CSS 工具类的实现 |
| [`cash-dom`](https://github.com/fabiospampinato/cash) | [MIT](https://github.com/fabiospampinato/cash/blob/master/license) | 一个轻量的 DOM 操作库，提供类 jQuery 辅助工具，用于处理 DOM 操作 |
