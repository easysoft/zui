...
<script setup>
    const colors = [
        {
            ...
            items: [
                ...
                {name: 'bg-surface-light', hint: '轻量的控件'},
                {name: 'bg-surface', hint: '控件'},
                {name: 'bg-surface-strong', hint: '加重的控件'},
    ...
    const opacityList = [
        {name: 'bg-opacity-0', hint: '不透明度：0%'},
        {name: 'bg-opacity-5', hint: '不透明度：5%'},
        {name: 'bg-opacity-10', hint: '不透明度：10%'},
        {name: 'bg-opacity-20', hint: '不透明度：20%'},
        {name: 'bg-opacity-25', hint: '不透明度：25%'},
        {name: 'bg-opacity-30', hint: '不透明度：30%'},
        {name: 'bg-opacity-40', hint: '不透明度：40%'},
        {name: 'bg-opacity-50', hint: '不透明度：50%'},
        {name: 'bg-opacity-60', hint: '不透明度：60%'},
        {name: 'bg-opacity-70', hint: '不透明度：70%'},
        {name: 'bg-opacity-75', hint: '不透明度：75%'},
        {name: 'bg-opacity-80', hint: '不透明度：80%'},
        {name: 'bg-opacity-90', hint: '不透明度：90%'},
        {name: 'bg-opacity-95', hint: '不透明度：95%'},
        {name: 'bg-opacity-100', hint: '不透明度：100%'},
    ];
</script>
