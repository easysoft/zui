...
<script setup>
    ...
    const opacityList = [
        {name: 'text-opacity-0', hint: '不透明度：0%'},
        {name: 'text-opacity-5', hint: '不透明度：5%'},
        {name: 'text-opacity-10', hint: '不透明度：10%'},
        {name: 'text-opacity-20', hint: '不透明度：20%'},
        {name: 'text-opacity-25', hint: '不透明度：25%'},
        {name: 'text-opacity-30', hint: '不透明度：30%'},
        {name: 'text-opacity-40', hint: '不透明度：40%'},
        {name: 'text-opacity-50', hint: '不透明度：50%'},
        {name: 'text-opacity-60', hint: '不透明度：60%'},
        {name: 'text-opacity-70', hint: '不透明度：70%'},
        {name: 'text-opacity-75', hint: '不透明度：75%'},
        {name: 'text-opacity-80', hint: '不透明度：80%'},
        {name: 'text-opacity-90', hint: '不透明度：90%'},
        {name: 'text-opacity-95', hint: '不透明度：95%'},
        {name: 'text-opacity-100', hint: '不透明度：100%'},
    ];
</script>
