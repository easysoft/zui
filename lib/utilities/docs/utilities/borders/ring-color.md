...
<script setup>
    ...
    const opacityList = [
        {name: 'ring-opacity-0', hint: '不透明度：0%'},
        {name: 'ring-opacity-5', hint: '不透明度：5%'},
        {name: 'ring-opacity-10', hint: '不透明度：10%'},
        {name: 'ring-opacity-20', hint: '不透明度：20%'},
        {name: 'ring-opacity-25', hint: '不透明度：25%'},
        {name: 'ring-opacity-30', hint: '不透明度：30%'},
        {name: 'ring-opacity-40', hint: '不透明度：40%'},
        {name: 'ring-opacity-50', hint: '不透明度：50%'},
        {name: 'ring-opacity-60', hint: '不透明度：60%'},
        {name: 'ring-opacity-70', hint: '不透明度：70%'},
        {name: 'ring-opacity-75', hint: '不透明度：75%'},
        {name: 'ring-opacity-80', hint: '不透明度：80%'},
        {name: 'ring-opacity-90', hint: '不透明度：90%'},
        {name: 'ring-opacity-95', hint: '不透明度：95%'},
        {name: 'ring-opacity-100', hint: '不透明度：100%'},
    ];
</script>
