...
<script setup>
    const colors = [
        {
            ...
            items: [
                ...
                {name: 'border-surface-light', hint: '轻量的控件'},
                {name: 'border-surface', hint: '控件'},
                {name: 'border-surface-strong', hint: '加重的控件'},
    ...
    const opacityList = [
        {name: 'border-opacity-0', hint: '不透明度：0%'},
        {name: 'border-opacity-5', hint: '不透明度：5%'},
        {name: 'border-opacity-10', hint: '不透明度：10%'},
        {name: 'border-opacity-20', hint: '不透明度：20%'},
        {name: 'border-opacity-25', hint: '不透明度：25%'},
        {name: 'border-opacity-30', hint: '不透明度：30%'},
        {name: 'border-opacity-40', hint: '不透明度：40%'},
        {name: 'border-opacity-50', hint: '不透明度：50%'},
        {name: 'border-opacity-60', hint: '不透明度：60%'},
        {name: 'border-opacity-70', hint: '不透明度：70%'},
        {name: 'border-opacity-75', hint: '不透明度：75%'},
        {name: 'border-opacity-80', hint: '不透明度：80%'},
        {name: 'border-opacity-90', hint: '不透明度：90%'},
        {name: 'border-opacity-95', hint: '不透明度：95%'},
        {name: 'border-opacity-100', hint: '不透明度：100%'},
    ];
</script>
