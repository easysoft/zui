...
<span class="tag -white-outline">white</span>
...
<span class="tag -inverse-outline">inverse</span>
<span class="tag -surface-outline">surface</span>
<span class="tag -canvas-outline">canvas</span>
<span class="tag -ghost-outline">ghost</span>
```
