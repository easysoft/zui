...
// Importing core must not require a Custom Elements environment.
const ElementBase = typeof HTMLElement === 'undefined' ? Object as unknown as typeof HTMLElement : HTMLElement;
