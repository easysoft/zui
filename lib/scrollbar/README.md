...
```html:example
<div style="width: 400px; height: 100px; overflow: scroll; white-space: nowrap">
  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, accusamus.</p>
  <p>Explicabo asperiores recusandae qui? Aliquam similique eaque animi nemo? Fugiat.</p>
...
## CSS Scrollbar thin size

```html:example
<div class="scrollbar-thin" style="width: 400px; height: 100px; overflow: scroll; white-space: nowrap">
  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, accusamus.</p>
  <p>Explicabo asperiores recusandae qui? Aliquam similique eaque animi nemo? Fugiat.</p>
  <p>Pariatur sapiente laboriosam cumque itaque, id saepe commodi accusantium neque?</p>
  <p>Cupiditate eaque, doloribus magnam velit ipsum maiores voluptatum eveniet rem!</p>
...
## CSS scrollbar hover effection

```html:example
<div class="scrollbar-hover" style="width: 400px; height: 100px; overflow: scroll; white-space: nowrap">
  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, accusamus.</p>
  <p>Explicabo asperiores recusandae qui? Aliquam similique eaque animi nemo? Fugiat.</p>
  <p>Pariatur sapiente laboriosam cumque itaque, id saepe commodi accusantium neque?</p>
  <p>Cupiditate eaque, doloribus magnam velit ipsum maiores voluptatum eveniet rem!</p>
...
```html:example
<div style="overflow: overlay; width: 400px; height: 100px; white-space: nowrap">
  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, accusamus.</p>
  <p>Explicabo asperiores recusandae qui? Aliquam similique eaque animi nemo? Fugiat.</p>
  <p>Pariatur sapiente laboriosam cumque itaque, id saepe commodi accusantium neque?</p>
  <p>Cupiditate eaque, doloribus magnam velit ipsum maiores voluptatum eveniet rem!</p>
