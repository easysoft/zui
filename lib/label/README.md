...
<span class="label -white-outline">white</span>
...
<span class="label -inverse-outline">inverse</span>
<span class="label -surface-outline">surface</span>
<span class="label -canvas-outline">canvas</span>
