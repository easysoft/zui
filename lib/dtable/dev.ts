...
domReady(() => {
    ...
    if (element) {
        const datatable = new DTablePlugin(element, {
            cols: [
                {name: 'id', title: 'ID', width: 80, fixed: 'left', sortType: 'down'},
                ...
                {name: 'startDate', title: '开始日期', align: 'center', sortType: true},
                {name: 'endDate', title: '开始日期', align: 'center', sortType: true},
