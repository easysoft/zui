...
const yu = "3.0.0-alpha.4", vu = 1716974414513, Lt = document, Cn = window, Tr = Lt.documentElement, he = Lt.createElement.bind(Lt), Nr = he("div"), us = he("table"), Ra = he("tbody"), Ui = he("tr"), { isArray: Vn, prototype: Er } = Array, { concat: Da, filter: Ys, indexOf: $r, map: Mr, push: La, slice: Ar, some: Js, splice: Fa } = Er, za = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, Oa = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Ha = /<.+>/, Wa = /^\w+$/;
function Zs(n, t) {
  const e = ja(t);
...
class Un {
  constructor(t, e) {
    ...
    if (et(t)) {
      const i = e || Lt;
      if (s = za.test(t) && ae(i) ? i.getElementById(t.slice(1).replace(/\\/g, "")) : Ha.test(t) ? Rr(t) : Ss(i) ? i.find(t) : et(i) ? d(i).find(t) : Zs(t, i), !s)
        return;
    } else if (ue(t))
      return this.ready(t);
...
Z([!0, !1], (n, t) => {
  Z(["Width", "Height"], (e, s) => {
    ...
    C[i] = function(r) {
      if (this[0])
        return be(this[0]) ? t ? this[0][`inner${s}`] : this[0].document.documentElement[`client${s}`] : ae(this[0]) ? Or(this[0], s) : this[0][`${t ? "offset" : "client"}${s}`] + (r && t ? xt(this[0], `margin${e ? "Top" : "Left"}`) + xt(this[0], `margin${e ? "Bottom" : "Right"}`) : 0);
    };
  });
});
Z(["Width", "Height"], (n, t) => {
  ...
  C[e] = function(s) {
    ...
    if (!arguments.length)
      return be(this[0]) ? this[0].document.documentElement[`client${t}`] : ae(this[0]) ? Or(this[0], t) : this[0].getBoundingClientRect()[e] - Ki(this[0], !n);
...
function ml(n, t, e, s, i) {
  ...
  return et(t) || (ft(t) || We(t) ? t = "" : ft(e) ? (e = t, t = "") : (s = e, e = t, t = "")), ue(s) || (s = e, e = void 0), s ? (Z(Kn(n), (r, o) => {
    ...
    c && this.each((p, f) => {
      ...
      m.guid = s.guid = s.guid || d.guid++, gl(f, c, l, t, m);
    });
  }), this) : this;
}
C.on = ml;
...
function Ie(n, t, e) {
  e != null && (Array.isArray(e) ? e.forEach((s) => Ie(n, t, s)) : n.append(t, e instanceof Blob ? e : String(e)));
}
function Tl(n, t) {
  if (n) {
    const e = {
...
d.share = $l;
var Gn, H, Yr, bt, ie, tr, Jr, Ts, li, Ns, Es, je = {}, Zr = [], Ml = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Yn = Array.isArray;
function Kt(n, t) {
  for (var e in t)
    n[e] = t[e];
  return n;
...
function Al(n, t, e) {
  ...
  for (n.__k = [], s = 0; s < l; s++)
    o = s + h, (i = n.__k[s] = (i = t[s]) == null || typeof i == "boolean" || typeof i == "function" ? null : typeof i == "string" || typeof i == "number" || typeof i == "bigint" || i.constructor == String ? pn(null, i, null, null, null) : Yn(i) ? pn(ke, { children: i }, null, null, null) : i.constructor === void 0 && i.__b > 0 ? pn(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v) : i) != null ? (i.__ = n, i.__b = n.__b + 1, a = Il(i, e, o, u), i.__i = a, r = null, a !== -1 && (u--, (r = e[a]) && (r.__u |= 131072)), r == null || r.__v === null ? (a == -1 && h--, typeof i.type != "function" && (i.__u |= 65536)) : a !== o && (a === o + 1 ? h++ : a > o ? u > l - o ? h += a - o : h-- : a < o ? a == o - 1 && (h = a - o) : h = 0, a !== s + h && (i.__u |= 65536))) : (r = e[o]) && r.key == null && r.__e && !(131072 & r.__u) && (r.__e == n.__d && (n.__d = le(r)), $s(r, r, !1), e[o] = null, u--);
  if (u)
    for (s = 0; s < c; s++)
...
function ci(n, t, e, s, i, r, o, a, l, c) {
  ...
  t:
    if (typeof M == "function")
      try {
        if (v = t.props, b = (u = M.contextType) && s[u.__c], w = u ? b ? b.props.value : u.__ : s, e.__c ? y = (h = t.__c = e.__c).__ = h.__E : ("prototype" in M && M.prototype.render ? t.__c = h = new M(v, w) : (t.__c = h = new B(v, w), h.constructor = M, h.render = Rl), b && b.sub(h), h.props = v, h.state || (h.state = {}), h.context = w, h.__n = s, p = h.__d = !0, h.__h = [], h._sb = []), h.__s == null && (h.__s = h.state), M.getDerivedStateFromProps != null && (h.__s == h.state && (h.__s = Kt({}, h.__s)), Kt(h.__s, M.getDerivedStateFromProps(v, h.__s))), f = h.props, m = h.state, h.__v = t, p)
        ...
        if (h.context = w, h.props = v, h.__P = n, h.__e = !1, k = H.__r, T = 0, "prototype" in M && M.prototype.render) {
          ...
          while (h.__d && ++T < 25);
        h.state = h.__s, h.getChildContext != null && (s = Kt(Kt({}, s), h.getChildContext())), p || h.getSnapshotBeforeUpdate == null || (_ = h.getSnapshotBeforeUpdate(f, m)), to(n, Yn(I = u != null && u.type === ke && u.key == null ? u.props.children : u) ? I : [I], t, e, s, i, r, o, a, l, c), h.base = t.__e, t.__u &= -161, h.__h.length && o.push(h), y && (h.__E = h.__ = null);
      } catch (E) {
...
function ye(n, t, e) {
  var s, i, r, o;
  H.__ && H.__(n, t), i = (s = typeof e == "function") ? null : e && e.__k || t.__k, r = [], o = [], ci(t, n = (!s && e || t).__k = wt(ke, null, [n]), i || je, je, t.ownerSVGElement !== void 0, !s && e ? [e] : i ? null : t.firstChild ? Gn.call(t.childNodes) : null, r, !s && e ? e : i ? i.__e : t.firstChild, s, o), no(r, n, o);
}
...
}, B.prototype.render = ke, ie = [], Jr = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ts = function(n, t) {
...
function W(n) {
  const t = Ms(n);
  return t == null || typeof t == "boolean" ? null : bt(t) ? t : /* @__PURE__ */ g(ke, { children: t });
}
...
function mo(n) {
  ...
  t.componentWillUnmount = function() {
    ...
    wt(Xl, { context: t.context }, n._vnode),
    t._temp
  )) : t._temp && t.componentWillUnmount();
}
function Ql(n, t) {
  const e = wt(mo, { _vnode: n, _container: t });
...
var vc = (n, t, e) => {
  ...
  if (t.has(n))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n) : t.set(n, e);
}, Me = (n, t, e) => (vc(n, t, "access private method"), e), ee, pe;
class _i extends U {
  constructor() {
  ...
  show() {
    this.render(), this.emit("show"), Me(this, ee, pe).call(this, () => {
      this._show = !0, this.render(), Me(this, ee, pe).call(this, () => {
        this.emit("shown");
        const { time: t } = this.options;
        t && Me(this, ee, pe).call(this, () => this.hide(), t);
      });
    }, 100);
  }
  hide() {
    this._show && Me(this, ee, pe).call(this, () => {
      this.emit("hide"), this._show = !1, this.render(), Me(this, ee, pe).call(this, () => {
        this.emit("hidden");
      });
    }, 50);
  }
...
async function Ci(n, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: f = 0
  } = Te(t, n), m = xo(f), y = a[p ? h === "floating" ? "reference" : "floating" : h], v = In(await r.getClippingRect({
...
const Ic = (n) => ({
  ...
  async fn(t) {
    ...
    const I = S / 2 - k / 2, M = A / 2 - _[m] / 2 - 1, E = Gt(h[v], M), P = Gt(h[b], M), R = E, L = A - _[m] - P, $ = A / 2 - _[m] / 2 + I, z = Is(R, $, L), tt = !l.arrow && Ne(i) != null && $ !== z && r.reference[m] / 2 - ($ < R ? E : P) - _[m] / 2 < 0, gt = tt ? $ < R ? $ - R : $ - L : 0;
    return {
      [f]: p[f] + gt,
      data: {
        [f]: z,
  ...
  return n === void 0 && (n = {}), {
    ...
    async fn(t) {
      ...
      if ((e = r.arrow) != null && e.alignmentOffset)
        return {};
      const v = Jt(i), b = Jt(a) === a, w = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), S = p || (b || !_ ? [An(a)] : Nc(a));
      !p && m !== "none" && S.push(...$c(a, _, m, w));
      ...
      if (I = [...I, {
        ...
        if (!$)
          switch (f) {
            case "bestFit": {
              var P;
              const z = (P = I.map((tt) => [tt.placement, tt.overflows.filter((gt) => gt > 0).reduce((gt, ls) => gt + ls, 0)]).sort((tt, gt) => tt[1] - gt[1])[0]) == null ? void 0 : P[0];
              z && ($ = z);
              break;
            }
...
async function Rc(n, t) {
  const {
    ...
    platform: s,
    elements: i
  } = n, r = await (s.isRTL == null ? void 0 : s.isRTL(i.floating)), o = Jt(e), a = Ne(e), l = rn(e) === "y", c = ["left", "top"].includes(o) ? -1 : 1, u = r && l ? -1 : 1, h = Te(t, n);
  let {
    mainAxis: p,
    crossAxis: f,
    alignmentAxis: m
  ...
  return n === void 0 && (n = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: s
      }, u = await Ci(t, l), h = rn(Jt(i)), p = ko(h);
      let f = c[p], m = c[h];
      if (r) {
  ...
  return n === void 0 && (n = {}), {
    ...
    async fn(t) {
      const {
        ...
        ...a
      } = Te(n, t), l = await Ci(t, a), c = Jt(e), u = Ne(e), h = rn(e) === "y", {
        width: p,
        height: f
      } = s.floating;
      let m, _;
...
function No(n) {
  const t = Zt(n);
  return Ce(t) ? n.ownerDocument ? n.ownerDocument.body : n.body : Nt(t) && on(t) ? t : No(t);
}
function Ve(n, t, e) {
  var s;
...
function Bc(n) {
  ...
  const u = Yt(0), h = Nt(s);
  if ((h || !h && !r) && ((Ee(s) !== "body" || on(o)) && (l = ns(s)), Nt(s))) {
    const p = ce(s);
    c = ve(s), u.x = p.x + s.clientLeft, u.y = p.y + s.clientTop;
  }
  return {
    width: e.width * c.x,
    height: e.height * c.y,
...
function qc(n, t) {
  const e = ce(n, !0, t === "fixed"), s = e.top + n.clientTop, i = e.left + n.clientLeft, r = Nt(n) ? ve(n) : Yt(1), o = n.clientWidth * r.x, a = n.clientHeight * r.y, l = i * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function Gc(n, t) {
  ...
  if (e)
    return e;
  let s = Ve(n, [], !1).filter((a) => Tt(a) && Ee(a) !== "body"), i = null;
  const r = kt(n).position === "fixed";
  let o = r ? Zt(n) : n;
  for (; Tt(o) && !Ce(o); ) {
    const a = kt(o), l = Si(o);
    !l && a.position === "fixed" && (i = null), (r ? !l && !i : !l && a.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || on(o) && !l && Ao(n, o)) ? s = s.filter((u) => u !== o) : i = a, o = Zt(o);
  }
  return t.set(n, s), s;
}
function Yc(n) {
...
function Io(n, t) {
  ...
  for (; s && zc(s) && _s(s); )
    s = ur(s, t);
  return s && Ce(s) && _s(s) && !Si(s) ? e : s || Oc(n) || e;
}
...
}, oe = (n, t = /* @__PURE__ */ new Date()) => F(n).toDateString() === F(t).toDateString(), Rs = (n, t = /* @__PURE__ */ new Date()) => F(n).getFullYear() === F(t).getFullYear(), zo = (n, t = /* @__PURE__ */ new Date()) => (n = F(n), t = F(t), n.getFullYear() === t.getFullYear() && n.getMonth() === t.getMonth()), Ru = (n, t = /* @__PURE__ */ new Date()) => {
  n = F(n), t = F(t);
  const e = 1e3 * 60 * 60 * 24, s = Math.floor(n.getTime() / e), i = Math.floor(t.getTime() / e);
  return Math.floor((s + 4) / 7) === Math.floor((i + 4) / 7);
}, Du = (n, t) => oe(F(t), n), Lu = (n, t) => oe(F(t).getTime() - Ue, n), Fu = (n, t) => oe(F(t).getTime() + Ue, n), Oo = (n) => !Number.isNaN(F(n).getTime()), pt = (n, t = "yyyy-MM-dd hh:mm", e = "") => {
  if (n = F(n), !Oo(n))
    return e;
  const s = {
    "M+": n.getMonth() + 1,
...
let Wo = class extends yt {
  ...
  _renderPop(t) {
    ...
    return /* @__PURE__ */ g(Ho, { hour: e, minute: s, minuteStep: t.minuteStep, onChange: this._handleSetTime });
  }
};
Wo.defaultProps = {
  ...yt.defaultProps,
...
class rh extends B {
  ...
  render(t) {
    ...
    const { startTime: m, days: _, firstDay: y } = ih(o, a, s), v = y + _ * Ue;
    let b = m;
    const w = [], S = "yyyy-MM-dd", k = fr(l, S), T = fr(c, S), A = ((M = u ? F(u) : null) == null ? void 0 : M.getTime()) ?? Number.MAX_SAFE_INTEGER, I = ((E = h ? F(h) : null) == null ? void 0 : E.getTime()) ?? 0;
    for (; b <= v; ) {
      const P = [];
      for (let R = 0; R < 7; R++) {
        const L = new Date(b), $ = L.getDate(), z = pt(L, S), tt = L.getDay(), gt = zo(L, y), ls = x("col mini-calendar-day", {
          active: k.has(z),
          selected: T.has(z),
          "is-first": $ === 1,
          "is-in-month": gt,
        ...
        P.push(
          /* @__PURE__ */ g("div", { className: ls, "data-date": z, children: /* @__PURE__ */ g("button", { type: "button", className: f, onClick: this._handleClickDate, children: $ === 1 && r ? r[L.getMonth()] : L.getDate() }) }, z)
        ), b += Ue;
      }
...
var Ye, Je, Ze, Xe, Qe, tn, jn, jo, Bn, Bo;
class oh extends B {
  constructor(e) {
    super(e);
    at(this, jn);
  ...
  render(e, s) {
    ...
    return /* @__PURE__ */ g("div", { className: "date-picker-menu row", ref: it(this, Ye), onClick: it(this, Je), children: [
      ...
      /* @__PURE__ */ g("div", { className: "cell", style: "width: 312px", children: [
        ...
        _ ? hs(this, Bn, Bo).call(this, e) : null
      ] })
    ] });
  }
}
Ye = new WeakMap(), Je = new WeakMap(), Ze = new WeakMap(), Xe = new WeakMap(), Qe = new WeakMap(), tn = new WeakMap(), jn = new WeakSet(), jo = function(e) {
  let { menu: s } = e;
  return s ? (Array.isArray(s) && (s = { items: s }), /* @__PURE__ */ g(J, { ...s })) : null;
}, Bn = new WeakSet(), Bo = function(e) {
  let { actions: s } = e;
...
let ss = class extends yt {
  constructor(t) {
    super(t), this.setDate = (s) => {
      ...
      let p = F(s);
      if (u) {
        const m = F(typeof u == "function" ? u(p) : u);
        p < m && (p = m);
      }
      if (h) {
        const m = F(typeof h == "function" ? h(p) : h);
        p > m && (p = m);
      }
...
qo.Component = Vo;
const gr = "show", mr = "in", ah = '[data-dismiss="modal"]', ys = "modal-hide", $e = class ne extends Ht {
  constructor() {
...
var Ai = (n, t, e) => {
  if (!t.has(n))
    throw TypeError("Cannot " + e);
}, vt = (n, t, e) => (Ai(n, t, "read from private field"), e ? e.call(n) : t.get(n)), Ae = (n, t, e) => {
  if (t.has(n))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n) : t.set(n, e);
...
async function ch(n, t) {
  ...
  return a !== !1 && e === "html" ? [c] : {
    title: o,
    ...r,
    body: e === "html" ? /* @__PURE__ */ g(we, { className: "modal-body", html: c, executeScript: l }) : c
  };
}
async function hh(n, t) {
  ...
  return {
    title: i,
    ...s,
    body: /* @__PURE__ */ g(Yo, { url: e, watchHeight: !o })
  };
}
const uh = {
  custom: lh,
  ajax: ch,
  iframe: hh
}, _r = "loading", Jo = class ge extends Ke {
  constructor() {
    super(...arguments), Ae(this, Pn), Ae(this, _n), Ae(this, Mt, void 0), Ae(this, De, void 0), Ae(this, At, void 0);
  }
  get id() {
    return vt(this, De);
  }
...
class qt extends ht {
  ...
  _getRenderOptions() {
    ...
    return this._dynamic ? {
      ...
      contentClass: "",
      popup: !1,
      content: wt(Fi, this._getMenuOptions())
    } : t;
  }
}
qt.NAME = "Dropdown";
...
function Nh(n = [], t = !0) {
  return t && Dn.length && n.unshift(...Dn), n != null && n.length ? ca([], n, /* @__PURE__ */ new Set()) : [];
}
function ha() {
  return {
    cols: [],
...
function $h(n, t, e, s) {
  ...
  if (e.forEach((b) => {
    ...
    A && A.forEach(($) => {
      ...
      z && Object.assign(k, z, b);
    });
    const { fixed: I, flex: M, minWidth: E = r, maxWidth: P = o } = k, R = wr(k.width || i, i);
    T.flex = M === !0 ? 1 : typeof M == "number" ? M : 0, T.width = Eh(R < 1 ? Math.round(R * s) : R, E, P), y.forEach(($) => $.call(n, T)), f.push(T), m[T.name] = T;
...
function Mh(n) {
  ...
  T == null || T.forEach(($) => {
    if (typeof $ == "object" && $ && !bt($) && ("html" in $ || "className" in $ || "style" in $ || "attrs" in $ || "children" in $ || "tagName" in $)) {
      const z = $.outer ? A : I;
      $.html ? z.push(/* @__PURE__ */ g("div", { className: x("dtable-cell-html", $.className), style: $.style, dangerouslySetInnerHTML: { __html: $.html }, ...$.attrs ?? {} })) : ($.style && Object.assign($.outer ? m : v, $.style), $.className && ($.outer ? b : w).push($.className), $.children && z.push($.children), $.attrs && Object.assign($.outer ? M : E, $.attrs)), $.tagName && !$.outer && (P = $.tagName);
    } else
      I.push($);
  });
  const R = P;
...
var Hi = (n, t, e) => {
  ...
  if (t.has(n))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(n) : t.set(n, e);
}, G = (n, t, e, s) => (Hi(n, t, "write to private field"), s ? s.call(n, e) : t.set(n, e), e), lt = (n, t, e) => (Hi(n, t, "access private method"), e), me, Le, Se, Dt, re, rt, Pt, It, Fe, yn, Ln, Ge, jt, ze, Oe, zs, da, Os, fa, Hs, pa, Ws, ga, vn, js, as, Fn, Bs, Vs, Us, Ks, He, bn, zn, Wi, ji, ma, qs, _a;
let Bi = class extends B {
  constructor(t) {
    super(t), D(this, zs), D(this, Os), D(this, Hs), D(this, Ws), D(this, vn), D(this, He), D(this, zn), D(this, ji), D(this, qs), this.ref = q(), D(this, me, 0), D(this, Le, void 0), D(this, Se, !1), D(this, Dt, void 0), D(this, re, void 0), D(this, rt, []), D(this, Pt, void 0), D(this, It, /* @__PURE__ */ new Map()), D(this, Fe, {}), D(this, yn, void 0), D(this, Ln, []), D(this, Ge, { in: !1 }), this.updateLayout = () => {
    ...
    }), G(this, Le, t.id ?? `dtable-${ut()}`), this.state = { scrollTop: 0, scrollLeft: 0, renderCount: 0 }, G(this, re, Object.freeze(Nh(t.plugins))), N(this, re).forEach((e) => {
    ...
    }), lt(this, zn, Wi).call(this), N(this, rt).forEach((e) => {
      var s;
  ...
  componentDidMount() {
    N(this, Se) ? this.forceUpdate() : lt(this, vn, js).call(this), this.on("click", N(this, Bs)), this.on("keydown", N(this, Vs));
  ...
  componentWillUnmount() {
    ...
    if (t)
      for (const s of N(this, It).keys())
        s.startsWith("window_") ? window.removeEventListener(s.replace("window_", ""), N(this, ze)) : s.startsWith("document_") ? document.removeEventListener(s.replace("document_", ""), N(this, Oe)) : t.removeEventListener(s, N(this, jt));
    N(this, rt).forEach((s) => {
      var i;
  ...
  on(t, e, s) {
    ...
    i ? i.push(e) : (N(this, It).set(t, [e]), t.startsWith("window_") ? window.addEventListener(t.replace("window_", ""), N(this, ze)) : t.startsWith("document_") ? document.addEventListener(t.replace("document_", ""), N(this, Oe)) : (r = this.element) == null || r.addEventListener(t, N(this, jt)));
  }
  off(t, e, s) {
    var o;
    s && (t = `${s}_${t}`);
    ...
    if (!i)
      return;
    const r = i.indexOf(e);
    r >= 0 && i.splice(r, 1), i.length || (N(this, It).delete(t), t.startsWith("window_") ? window.removeEventListener(t.replace("window_", ""), N(this, ze)) : t.startsWith("document_") ? document.removeEventListener(t.replace("document_", ""), N(this, Oe)) : (o = this.element) == null || o.removeEventListener(t, N(this, jt)));
  }
  emitCustomEvent(t, e) {
  ...
  render() {
    ...
    if (t) {
      ...
      ), t.scrollable && f.push(lt(this, Ws, ga).call(this, t))), N(this, rt).forEach((_) => {
        var v;
...
Wi = function() {
  if (N(this, Dt))
    return !1;
  const t = { ...ha(), ...N(this, re).reduce((e, s) => {
...
_a = function() {
  (lt(this, zn, Wi).call(this) || !N(this, Pt)) && lt(this, ji, ma).call(this);
  const { layout: n } = this;
  if (!n)
    return;
...
const Ah = {
  ...
  onRenderCell(n, t) {
    ...
    if (e && (n = ka(n, t, e)), n = Ca(n, t), n = wa(n, t), s ? n = Gs(n, t) : n = ba(n, t), i) {
      let o = t.value;
...
const fn = "dtable-nested-toggle", Yh = {
  name: "nested",
  plugins: [Kh],
  defaultOptions: {
    nested: "auto",
...
}, du = st(uu), fu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  NestedRowState: Ta,
  avatar: Xh,
  cellspan: ou,
...
const gu = "nav", wn = '[data-toggle="tab"]', mu = "active";
class Pa extends Ht {
  constructor() {
  ...
  active(t) {
    ...
    let i = t ? d(t).closest(wn) : s.filter(`.${mu}`);
...
d(document).on("click.tabs.zui", wn, (n) => {
  n.preventDefault();
  const t = d(n.target), e = t.closest(`.${gu}`);
