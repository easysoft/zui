---
name: zui-optimize
description: "审计并优化一个、多个或全部 ZUI 3 `lib/*` 库，覆盖组件与 helper 代码质量、缺陷检查和修复、公开 API 文档、开发调试示例、国际化及规范一致性。Use when a user asks for a quality pass, audit, cleanup, defect remediation, documentation completion, playground expansion, i18n improvement, or standards-based optimization across existing ZUI libraries; 修改前先形成范围明确的优化计划并等待确认。"
---
