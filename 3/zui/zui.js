...
var Ue, C, Pt, de, ut, jt = {}, It = [], rn = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function G(n, t) {
  for (var e in t)
    n[e] = t[e];
  return n;
...
function gt(n) {
  (!n.__d && (n.__d = !0) && de.push(n) && !Ee.__r++ || ut !== C.debounceRendering) && ((ut = C.debounceRendering) || setTimeout)(Ee);
}
function Ee() {
  for (var n; Ee.__r = de.length; )
    n = de.sort(function(t, e) {
      ...
      var e, s, r, o, l, h;
      t.__d && (l = (o = (e = t).__v).__e, (h = e.__P) && (s = [], (r = G({}, o)).__v = o.__v + 1, qt(h, o, r, e.__n, h.ownerSVGElement !== void 0, o.__h != null ? [l] : null, s, l == null ? ce(o) : l, o.__h), an(s, o), o.__e != l && Ot(o)));
    });
}
...
function mt(n, t, e) {
  t[0] === "-" ? n.setProperty(t, e) : n[t] = e == null ? "" : typeof e != "number" || rn.test(t) ? e : e + "px";
}
  ...
  e:
    if (t === "style")
      if (typeof e == "string")
        ...
        if (typeof s == "string" && (n.style.cssText = s = ""), s)
          for (t in s)
            e && t in e || mt(n.style, t, "");
        if (e)
          for (t in e)
            s && e[t] === s[t] || mt(n.style, t, e[t]);
      }
    else if (t[0] === "o" && t[1] === "n")
      o = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in n ? t.toLowerCase().slice(2) : t.slice(2), n.l || (n.l = {}), n.l[t + o] = e, e ? s || n.addEventListener(t, o ? bt : yt, o) : n.removeEventListener(t, o ? bt : yt, o);
    else if (t !== "dangerouslySetInnerHTML") {
      if (r)
        t = t.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
      else if (t !== "href" && t !== "list" && t !== "form" && t !== "tabIndex" && t !== "download" && t in n)
  ...
  try {
    e:
      if (typeof w == "function") {
        ...
        o == null && t.__v === e.__v ? (t.__k = e.__k, t.__e = e.__e) : t.__e = cn(e.__e, t, e, s, r, o, l, c);
    (p = C.diffed) && p(t);
  } catch (H) {
...
Ue = It.slice, C = { __e: function(n, t, e, s) {
  ...
  var e;
  e = this.__s != null && this.__s !== this.state ? this.__s : this.__s = G({}, this.state), typeof n == "function" && (n = n(G({}, e), this.props)), n && G(e, n), n != null && this.__v && (t && this.__h.push(t), gt(this));
}, fe.prototype.forceUpdate = function(n) {
  this.__v && (this.__e = !0, n && this.__h.push(n), gt(this));
...
class vt extends fe {
  constructor(e) {
    ...
    S(this, "_handleMouseMove", (e) => {
      ...
      s && (m(this, Z) && cancelAnimationFrame(m(this, Z)), E(this, Z, requestAnimationFrame(() => {
        const r = this.props.type === "horz" ? e.clientX - s.x : e.clientY - s.y;
        this.scroll(s.offset + r * this.props.scrollSize / this.props.clientSize), E(this, Z, 0);
      })), e.preventDefault());
    });
  ...
  componentDidMount() {
    ...
    e && (E(this, K, typeof e == "string" ? document : e.current), m(this, K).addEventListener("wheel", this._handleWheel, { passive: !1 }));
  }
  componentWillUnmount() {
    document.removeEventListener("mousemove", this._handleMouseMove), document.removeEventListener("mouseup", this._handleMouseUp), m(this, K) && m(this, K).removeEventListener("wheel", this._handleWheel);
  }
  scroll(e) {
  ...
  render() {
    ...
    return r === "horz" ? (b.height = o, b.width = s, f.width = Math.max(Math.round(s * s / e), o), f.left = Math.round(a * (s - f.width) / _)) : (b.width = o, b.height = s, f.height = this.barSize, f.top = Math.round(a * (s - f.height) / _)), /* @__PURE__ */ pt("div", {
...
customElements.get("zui-button") || customElements.define("zui-button", dn);
var Q, ue;
class wt {
  constructor(t) {
    L(this, Q, void 0);
    L(this, ue, void 0);
    var e;
    E(this, Q, t), E(this, ue, t.nextElementSibling), ((e = m(this, Q).dataset) == null ? void 0 : e.toggle) === "dropdown" && !m(this, Q).parentElement.className.includes("dropdown-hover") && this.toggle(m(this, Q).parentElement, m(this, ue));
  }
  toggle(t, e) {
...
Q = new WeakMap(), ue = new WeakMap();
document.addEventListener("click", function(n) {
  n !== null && n.target instanceof HTMLElement && (n.target.dataset.toggle === "dropdown" ? new wt(n.target) : new wt(n).clearMenu());
});
