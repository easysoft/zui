...
var Ot = (s, t, e) => t in s ? Pt(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var k = (s, t, e) => (Ot(s, typeof t != "symbol" ? t + "" : t, e), e), We = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
};
var u = (s, t, e) => (We(s, t, "read from private field"), e ? e.call(s) : t.get(s)), M = (s, t, e) => {
  if (t.has(s))
...
var $e, E, mt, he, ct, Se = {}, bt = [], Ut = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function q(s, t) {
  for (var e in t)
    s[e] = t[e];
  return s;
...
function we(s, t, e, n, o) {
  var i = { type: s, props: t, key: e, ref: n, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: o == null ? ++mt : o };
...
function Re() {
  for (var s; Re.__r = he.length; )
    s = he.sort(function(t, e) {
      ...
      var e, n, o, i, r, a;
      t.__d && (r = (i = (e = t).__v).__e, (a = e.__P) && (n = [], (o = q({}, i)).__v = i.__v + 1, Be(a, i, o, e.__n, a.ownerSVGElement !== void 0, i.__h != null ? [r] : null, n, r == null ? le(i) : r, i.__h), Ct(n, i), i.__e != r && wt(i)));
    });
}
function kt(s, t, e, n, o, i, r, a, c, d) {
  var l, _, p, f, g, S, m, y = n && n.__k || bt, w = y.length;
  for (e.__k = [], l = 0; l < t.length; l++)
    if ((f = e.__k[l] = (f = t[l]) == null || typeof f == "boolean" ? null : typeof f == "string" || typeof f == "number" || typeof f == "bigint" ? we(null, f, null, null, f) : Array.isArray(f) ? we(Ne, { children: f }, null, null, null) : f.__b > 0 ? we(f.type, f.props, f.key, null, f.__v) : f) != null) {
      if (f.__ = e, f.__b = e.__b + 1, (p = y[l]) === null || p && f.key == p.key && f.type === p.type)
        ...
        for (_ = 0; _ < w; _++) {
          if ((p = y[_]) && f.key == p.key && f.type === p.type) {
            y[_] = void 0;
            break;
          }
          p = null;
        }
      Be(s, f, p = p || Se, o, i, r, a, c, d), g = f.__e, (_ = f.ref) && p.ref != _ && (m || (m = []), p.ref && m.push(p.ref, null, f), m.push(_, f.__c || g, f)), g != null ? (S == null && (S = g), typeof f.type == "function" && f.__k === p.__k ? f.__d = c = St(f, c, s) : c = Rt(s, f, p, y, g, c), typeof e.type == "function" && (e.__d = c)) : c && p.__e == c && c.parentNode != s && (c = le(p));
    }
  for (e.__e = S, l = w; l--; )
...
function St(s, t, e) {
  for (var n, o = s.__k, i = 0; o && i < o.length; i++)
    (n = o[i]) && (n.__ = s, t = typeof n.type == "function" ? St(n, t, e) : Rt(e, n, n, o, n.__e, t));
  return t;
}
function Rt(s, t, e, n, o, i) {
  var r, a, c;
  if (t.__d !== void 0)
...
function Be(s, t, e, n, o, i, r, a, c) {
  var d, l, _, p, f, g, S, m, y, w, $, W, T, N = t.type;
  ...
  try {
    e:
      if (typeof N == "function") {
        if (m = t.props, y = (d = N.contextType) && n[d.__c], w = d ? y ? y.props.value : d.__ : n, e.__c ? S = (l = t.__c = e.__c).__ = l.__E : ("prototype" in N && N.prototype.render ? t.__c = l = new N(m, w) : (t.__c = l = new ee(m, w), l.constructor = N, l.render = Yt), y && y.sub(l), l.props = m, l.state || (l.state = {}), l.context = w, l.__n = n, _ = l.__d = !0, l.__h = []), l.__s == null && (l.__s = l.state), N.getDerivedStateFromProps != null && (l.__s == l.state && (l.__s = q({}, l.__s)), q(l.__s, N.getDerivedStateFromProps(m, l.__s))), p = l.props, f = l.state, _)
          ...
          if (N.getDerivedStateFromProps == null && m !== p && l.componentWillReceiveProps != null && l.componentWillReceiveProps(m, w), !l.__e && l.shouldComponentUpdate != null && l.shouldComponentUpdate(m, l.__s, w) === !1 || t.__v === e.__v) {
            l.props = m, l.state = l.__s, t.__v !== e.__v && (l.__d = !1), l.__v = t, t.__e = e.__e, t.__k = e.__k, t.__k.forEach(function(D) {
              D && (D.__ = t);
        ...
        if (l.context = w, l.props = m, l.__v = t, l.__P = s, $ = E.__r, W = 0, "prototype" in N && N.prototype.render)
          ...
          while (l.__d && ++W < 25);
        l.state = l.__s, l.getChildContext != null && (n = q(q({}, n), l.getChildContext())), _ || l.getSnapshotBeforeUpdate == null || (g = l.getSnapshotBeforeUpdate(p, f)), T = d != null && d.type === Ne && d.key == null ? d.props.children : d, kt(s, Array.isArray(T) ? T : [T], t, e, n, o, i, r, a, c), l.base = t.__e, t.__h = null, l.__h.length && r.push(l), S && (l.__E = l.__ = null), l.__e = !1;
      } else
        i == null && t.__v === e.__v ? (t.__k = e.__k, t.__e = e.__e) : t.__e = Ft(e.__e, t, e, n, o, i, r, c);
    (d = E.diffed) && d(t);
  } catch (D) {
    t.__v = null, (c || i != null) && (t.__e = a, t.__h = !!c, i[i.indexOf(a)] = null), E.__e(D, t, e);
  }
}
function Ct(s, t) {
...
function Ft(s, t, e, n, o, i, r, a) {
  var c, d, l, _ = e.props, p = t.props, f = t.type, g = 0;
  if (f === "svg" && (o = !0), i != null) {
    for (; g < i.length; g++)
  ...
  if (f === null)
    _ === p || a && s.data === p || (s.data = p);
  else {
    if (i = i && $e.call(s.childNodes), d = (_ = e.props || Se).dangerouslySetInnerHTML, l = p.dangerouslySetInnerHTML, !a) {
      if (i != null)
        for (_ = {}, g = 0; g < s.attributes.length; g++)
          _[s.attributes[g].name] = s.attributes[g].value;
      (l || d) && (l && (d && l.__html == d.__html || l.__html === s.innerHTML) || (s.innerHTML = l && l.__html || ""));
    }
    if (Bt(s, p, _, o, a), l)
      t.__k = [];
    else if (g = t.props.children, kt(s, Array.isArray(g) ? g : [g], t, e, n, o && f !== "foreignObject", i, r, i ? i[0] : e.__k && le(e, 0), a), i != null)
      for (g = i.length; g--; )
        i[g] != null && yt(i[g]);
    a || ("value" in p && (g = p.value) !== void 0 && (g !== s.value || f === "progress" && !g || f === "option" && g !== _.value) && Ce(s, "value", g, _.value, !1), "checked" in p && (g = p.checked) !== void 0 && g !== s.checked && Ce(s, "checked", g, _.checked, !1));
  }
  return s;
}
function Et(s, t, e) {
...
function xt(s, t, e) {
  var n, o;
  if (E.unmount && E.unmount(s), (n = s.ref) && (n.current && n.current !== s.__e || Et(n, null, t)), (n = s.__c) != null) {
...
function qt(s, t, e) {
  var n, o, i;
  E.__ && E.__(s, t), o = (n = typeof e == "function") ? null : e && e.__k || t.__k, i = [], Be(t, s = (!n && e || t).__k = b(Ne, null, [s]), o || Se, Se, t.ownerSVGElement !== void 0, !n && e ? [e] : o ? null : t.firstChild ? $e.call(t.childNodes) : null, i, !n && e ? e : o ? o.__e : t.firstChild, n), Ct(i, s);
}
$e = bt.slice, E = { __e: function(s, t, e, n) {
  ...
  throw s;
} }, mt = 0, ee.prototype.setState = function(s, t) {
  var e;
...
class ws extends ee {
  render() {
    ...
    return i ? _ = /* @__PURE__ */ b("img", {
      src: i,
      alt: r
    }) : _ = r, typeof t == "number" ? (l.width = t, l.height = t) : typeof t == "string" && d.push(`avatar-${t}`), typeof e == "string" && d.push(`rounded-${e}`), /* @__PURE__ */ b("div", {
      className: L(d),
      style: l,
      ...c
    }, _, a);
...
class _t extends ee {
  ...
  render() {
    const {
      ...
      bottom: l,
      right: _
    } = this.props, { maxScrollPos: p, scrollPos: f } = this, { dragStart: g } = this.state, S = {
      left: c,
      top: d,
      bottom: l,
      right: _,
...
function Fe({ col: s, className: t, height: e, rowID: n, hoverCol: o, rowData: i, onRenderCell: r, style: a, children: c, ...d }) {
  const { cellStyle: l, align: _, className: p } = s.setting, f = {
    left: s.left,
    width: s.realWidth,
    height: e,
...
function Zt({ col: s, children: t, style: e, ...n }) {
...
function je({ rowID: s, className: t, top: e = 0, left: n = 0, width: o, height: i, cols: r, data: a, hoverCol: c, CellComponent: d = Fe, onRenderCell: l }) {
  ...
  }, r.map((_) => _.visible ? /* @__PURE__ */ b(d, {
    key: _.name,
    col: _,
...
function Qt({ height: s, onRenderRow: t, ...e }) {
  let n = {
    height: s,
    ...e,
    rowID: "HEADER",
...
function es({
  ...
  return t = { ...t, top: e, height: o }, /* @__PURE__ */ b("div", {
    ...
    return r && (d = r(d, c)), /* @__PURE__ */ b(Mt, {
      ...d
    });
  }));
}
...
function ss(s) {
  return [s == null ? void 0 : s.plugins].flat().reduce((t, e) => {
    if (!e)
      return t;
    let n;
    return typeof e == "string" ? (n = ts(e), n || console.warn(`DTable: Cannot found plugin "${e}"`)) : typeof e == "function" ? n = e.plugin : typeof e == "object" ? n = e : console.warn("DTable: Invalid plugin", e), n && t.push(n), t;
  }, []);
}
function ns(s, t) {
  return s.reduce((e, n) => {
...
class De extends ee {
  constructor(e) {
    ...
    k(this, "_handleClick", (e) => {
      ...
      if (a === "HEADER")
        ...
        const m = (_ = u(this, se)) == null ? void 0 : _.visibleRows.find((y) => y.id === a);
        if (i) {
        ...
        if (((g = u(this, C).onRowClick) == null ? void 0 : g.call(this, e, { rowID: a, rowInfo: m, element: o })) === !0)
          return;
        for (const y of u(this, A))
  ...
  getLayout() {
    var Ze, Qe, et;
    const e = Ie(), n = ns(u(this, Q), { ...e, ...this.props }), o = u(this, Q).filter((h) => !h.when || h.when(n));
    R(this, A, Object.freeze(o)), o.forEach((h) => {
      var x;
      const v = (x = h.beforeLayout) == null ? void 0 : x.call(this, n);
      v && Object.assign(n, v);
    ...
    } = n, _ = i ? n.headerHeight || a : 0, p = r ? n.footerHeight || a : 0, f = (h, v, x) => (h && (v && (h = Math.max(v, h)), x && (h = Math.min(x, h))), h), g = [], S = [], m = [];
    let y = 0, w = 0;
    (Ze = n.cols) == null || Ze.forEach((h) => {
      ...
      if (h.hidden)
        return;
      h = { ...h };
      const { minWidth: v = d, maxWidth: x = l } = h, z = f((tt = h.width) != null ? tt : 0, v, x), U = (st = h.flex) != null ? st : 1, ge = U * f(c, v, x), B = {
        name: h.name,
      ...
      h.fixed === "left" ? (B.left = y, y += z, g.push(B)) : h.fixed === "right" ? (B.left = w, w += z, S.push(B)) : m.push(B), o.forEach((ot) => {
        var it, rt, lt;
    ...
    if (typeof $ == "function" && ($ = $()), $ === "auto")
      ...
      W = $ != null ? $ : 0;
    const { data: T, rowKey: N = "id" } = n, D = [], pe = (h, v, x) => {
      var U, ge;
      const z = { data: x != null ? x : { [N]: h }, top: 0, id: h, index: D.length };
      if (x || (z.lazy = !0), D.push(z), ((U = n.onAddRow) == null ? void 0 : U.call(this, z, v)) !== !1) {
        for (const B of o)
          if (((ge = B.onAddRow) == null ? void 0 : ge.call(this, z, v)) === !1)
            return;
      }
    };
    if (typeof T == "number")
      ...
      }) : typeof T == "object" && T && Object.entries(T).forEach(([h, v], x) => pe(h, x, v));
    const P = [];
    let ce = 0;
    D.forEach((h) => {
      var v, x;
    ...
    if (typeof O == "function" && (O = O()), O === "auto")
      ...
      K = Math.min(O.max, Math.max(O.min, _ + p + ce));
    else if (O === "100%") {
      ...
      K = O;
    const { scrollTop: _e = 0, scrollLeft: Le = 0, hoverCol: It } = this.state, qe = K - _ - p, Ke = _e + qe, Ve = [], Te = W - y - w;
    let V = 0;
    const ze = [];
    let Ge = 0;
    if (m.forEach((h) => {
      ...
      ze.forEach((v) => {
        var U;
        const { minWidth: x = d, maxWidth: z = l } = v.setting;
        v.realWidth = Math.min(z, Math.max(x, Math.ceil(h * ((U = v.flex) != null ? U : 1) / Ge))), V += v.realWidth;
      });
    }
    V = 0, m.forEach((h) => {
      h.left += V, V += h.realWidth, (h.left + h.realWidth < Le || h.left > Le + Te) && (h.visible = !1);
    });
    const Xe = Math.floor(_e / a), Je = Math.min(P.length, Math.ceil(Ke / a)), Dt = [];
    for (let h = Xe; h < Je; h++) {
      const v = P[h];
      v.top -= _e, Ve.push(v), v.lazy === !0 && Dt.push(v.id);
    }
    let te = {
      allRows: D,
      width: W,
  ...
  renderScrollBars(e) {
    const n = [], { scrollLeft: o, colsInfo: i, scrollTop: r, rowsHeight: a, rowsHeightTotal: c } = e, { scrollWidthTotal: d, scrollWidth: l } = i, { scrollbarSize: _ = 10, horzScrollbarPos: p } = this.props;
    return d > l && n.push(/* @__PURE__ */ b(_t, {
      key: "horz",
      type: "horz",
      scrollPos: o,
      scrollSize: d,
  ...
  render() {
    var _, p;
    const e = this.getLayout(), { className: n, rowHover: o, colHover: i, cellHover: r, bordered: a, striped: c, scrollbarHover: d } = (_ = u(this, C)) != null ? _ : this.props, l = { width: e == null ? void 0 : e.width, height: e == null ? void 0 : e.height };
    return /* @__PURE__ */ b("div", {
...
Z = new WeakMap(), F = new WeakMap(), C = new WeakMap(), Q = new WeakMap(), A = new WeakMap(), se = new WeakMap(), k(De, "addPlugin", $t), k(De, "removePlugin", Nt);
function os(s, t) {
  var i;
  const e = this.state.checkedRows, n = {}, o = (r, a) => {
    !!e[r] !== a && (a ? e[r] = !0 : delete e[r], n[r] = a);
  };
  return s === "HEADER" ? (t === void 0 && (t = !At.call(this)), (i = this.layout) == null || i.allRows.forEach(({ id: r }) => {
    o(r, !!t);
...
const Ht = {
  ...
  when: (s) => !!s.checkable,
  onCreate() {
    this.state.checkedRows = {}, this.toggleCheckRows = os.bind(this), this.isRowChecked = is.bind(this), this.isAllRowChecked = At.bind(this), this.getChecks = rs.bind(this);
  },
  onRenderCell(s, t, e) {
...
function Tt(s, t = 0, e) {
  ...
  for (const o of e) {
    const i = s.get(o);
    !i || typeof i.order == "number" || (i.order = t++, (n = i.children) != null && n.length && (t = Tt(s, t, i.children)));
  }
  return t;
}
const zt = {
  ...
  when: (s) => !!s.nested,
  onCreate() {
    this.nestedMap = /* @__PURE__ */ new Map(), this.toggleRow = ls.bind(this), this.isAllCollapsed = Lt.bind(this), this.getNestedRowInfo = Pe.bind(this);
  },
  beforeLayout() {
  ...
  onRenderCell(s, t, e, n) {
    ...
    if (o && (i.children || i.parent) && s.unshift((a = (r = this.options.onRenderNestedToggle) == null ? void 0 : r.call(this, i, t, e, n)) != null ? a : /* @__PURE__ */ b("button", {
      type: "button",
  ...
  onRenderHeaderCell(s, t, e) {
    var n, o;
    return e.setting.nestedToggle && s.unshift((o = (n = this.options.onRenderNestedToggle) == null ? void 0 : n.call(this, void 0, t, e, void 0)) != null ? o : /* @__PURE__ */ b("button", {
      type: "button",
      className: "dtable-nested-toggle state"
    }, /* @__PURE__ */ b("span", {
      className: "dtable-nested-toggle-icon"
...
const I = 24 * 60 * 60 * 1e3, H = (s) => s ? (s instanceof Date || (typeof s == "string" && (s = s.trim(), /^\d+$/.test(s) && (s = Number.parseInt(s, 10))), typeof s == "number" && s < 1e10 && (s *= 1e3), s = new Date(s)), s) : new Date(), ae = (s, t = new Date()) => (s = H(s), t = H(t), s.getFullYear() === t.getFullYear() && s.getMonth() === t.getMonth() && s.getDate() === t.getDate()), Oe = (s, t = new Date()) => H(s).getFullYear() === H(t).getFullYear(), Wt = (s, t = new Date()) => (s = H(s), t = H(t), s.getFullYear() === t.getFullYear() && s.getMonth() === t.getMonth()), as = (s, t = new Date()) => {
  s = H(s), t = H(t);
  const e = 1e3 * 60 * 60 * 24, n = Math.floor(s.getTime() / e), o = Math.floor(t.getTime() / e);
  return Math.floor((n + 4) / 7) === Math.floor((o + 4) / 7);
}, cs = (s, t) => ae(H(t), s), hs = (s, t) => ae(H(t).getTime() - I, s), ds = (s, t) => ae(H(t).getTime() + I, s), fs = (s, t) => ae(H(t).getTime() - 2 * I, s), xe = (s, t = "yyyy-MM-dd hh:mm") => {
  s = H(s);
  const e = {
    "M+": s.getMonth() + 1,
    "d+": s.getDate(),
  ...
  const n = {
    ...
    str: "{0} ~ {1}",
    ...e
  }, o = xe(s, Oe(s) ? n.month : n.full);
  if (ae(s, t))
    return o;
  const i = xe(t, Oe(s, t) ? Wt(s, t) ? n.day : n.month : n.full);
  ...
  colTypes: {
    ...
    format: {
      onRenderCell(s, t, e) {
        ...
        return typeof o == "function" ? s[0] = i === "html" ? { html: o(r) } : o(r) : i === "datetime" ? s[0] = xe(r, o) : i === "html" ? s[0] = { html: ye(o, r) } : s[0] = ye(o, r), s;
      }
    }
  }
};
...
class ve {
  constructor(t, e) {
    ...
    M(this, fe, vt());
    var n;
    this.element = t, this.options = { ...Ie(), ...e }, (n = this.options.cols) != null && n.length && this.render();
  }
  get $() {
    return u(this, fe).current;
  }
  render(t) {
    this.options = Object.assign(this.options, t), qt(/* @__PURE__ */ b(De, {
      ref: u(this, fe),
      ...this.options
    }), this.element);
  }
}
fe = new WeakMap(), k(ve, "NAME", "zui.dtable"), k(ve, "definePlugin", Ae), k(ve, "removePlugin", Nt), k(ve, "plugins", _s);
let gs = (s = 21) => crypto.getRandomValues(new Uint8Array(s)).reduce((t, e) => (e &= 63, e < 36 ? t += e.toString(36) : e < 62 ? t += (e - 26).toString(36).toUpperCase() : e > 62 ? t += "-" : t += "_", t), "");
var ue, Y, j, ne, oe, ke;
const Ye = class {
  constructor(t, e = "local") {
    ...
    M(this, j, void 0);
    M(this, ne, void 0);
    R(this, ue, e), R(this, Y, `ZUI_STORE:${t != null ? t : gs()}`), R(this, j, e === "local" ? localStorage : sessionStorage);
  }
  get type() {
    return u(this, ue);
  }
  ...
  adjustPosition(t, e) {
    ...
    if (t === "fit" ? r = `${i > 50 ? Math.floor(i * 2 / 3) : i}px` : t === "center" ? r = `${i}px` : this.isPlainObject(t) || (r = t), n.setAttribute("style", `top: ${r}`), n.className.includes("-fullscreen")) {
      ...
      if (((a = n.childNodes) == null ? void 0 : a.length) && n.childNodes.length === 1 ? c = n.childNodes[0] : c = n.childNodes[1], c) {
        const d = (c == null ? void 0 : c.getElementsByClassName("modal-header")[0].clientHeight) || 0, l = c == null ? void 0 : c.getElementsByClassName("modal-body")[0], _ = (c == null ? void 0 : c.getElementsByClassName("modal-footer")[0].clientHeight) || 0, p = o - d - _, f = l && l.scrollHeight > p ? "auto" : "visible";
